        ...
        <header>
            <div id="site_title">
                ...
                <div class="member_buttonarea">
                    <input type="member_registration" href="/healthcare/resources/views/Member registration/index.blade.php" value="会員登録">
                    <input type="login"   href="/healthcare/resources/views/Login/index.blade.php" value="ログイン">
                </div>
            ...
            <nav id="g-nav">
                <div id="g-nav-list">
                    <ul>
                        ...
                        <li><a href="/healthcare/resources/views/news/index.blade.php">
                                                        NEWS<br>ニュース</a></li>
